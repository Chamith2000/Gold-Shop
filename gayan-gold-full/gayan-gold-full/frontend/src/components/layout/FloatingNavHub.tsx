          ...
          >
            ...
            {isAdmin && (
              <button
                ...
                className={`w-full text-left px-3 py-2 rounded-xl flex items-center gap-2.5 transition-all border border-[#D4AF37]/50 ${
                  currentView === "admin"
                    ? "bg-[#5A0F1B] text-[#F3E5AB] font-bold"
                    : "bg-stone-900 text-[#F3E5AB] hover:bg-black"
                }`}
              >
                ...
                <div>
                  ...
                  <span className="text-[10px] text-[#F3E5AB]/70">Control Dashboard</span>
                </div>
              </button>
            )}
          </motion.div>
